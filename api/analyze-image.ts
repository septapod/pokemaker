...
- Overall body shape (round, oval, angular, etc.) - Size proportions (head to body ratio, limb sizes) - Physical features (number and shape of eyes, limbs, appendages) - Colors (specific shades, where each color appears) - Surface texture (smooth, fuzzy, scaly, rough) - Patterns or markings (stripes, spots, gradients)
- Facial features (eye shape, mouth shape, nose if any) ${userDescription ? `Creator's note: "${userDescription}"` : ''}
